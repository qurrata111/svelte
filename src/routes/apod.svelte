			...
			<div class="p-4 text-center">
				...
				<div class="p-2">
					...
					<div class="flex justify-center items-center">
						<input class="border rounded py-1 px-2 shadow-sm hover:shadow" type="date" bind:value={date} max={format(new Date(), "yyyy-MM-dd")} />
						<span class="items-center px-2" >
							<button on:click={handleRequest} class="p-2 items-center bg-gray-100 rounded shadow-sm hover:shadow hover:bg-gray-200">
								<svg
